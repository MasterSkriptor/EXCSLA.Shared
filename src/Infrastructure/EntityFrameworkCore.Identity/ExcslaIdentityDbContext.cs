...
namespace EXCSLA.Shared.Infrastructure.Data
{
    ...
    public abstract class ExcslaIdentityDbContext : IdentityDbContext
    {
        private readonly IDomainEventDispatcher _dispatcher;

        public ExcslaIdentityDbContext(DbContextOptions options, IDomainEventDispatcher dispatcher) : base(options)
        {
